export default function Footer() {
  ...
  return (
    <footer className="w-full border-t border-[var(--border-default)] mt-auto">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-4 text-xs text-[var(--text-muted)]">
          <a
            href="https://github.com/sadiqsyeds/link-shrink"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-[var(--text-primary)] transition-colors duration-150 flex items-center gap-1"
          >
            <svg
              width="12"
              height="12"
